...
function Epoch(name,mode,targetelement,multiselect,cdate='')
{
	this.state = 0;
	this.name = name;
	var mydate = new Date();
	if (cdate!='') {mydate=new Date(cdate);}
	//mydate.setYear(2011);
	//mydate.setMonth(0);
	//mydate.setDate(1);
...
Epoch.prototype.createMainHeading = function () //PRIVATE: Creates the primary calendar heading, with months & years
{
	...
	monthUp.setAttribute('style','padding-left:10px;padding-right:10px;');
	monthUp.setAttribute('class','btn-3 bg-primary');
	monthDn.setAttribute('type','button');
	monthDn.setAttribute('value','<');
	monthDn.setAttribute('title',this.monthdn_title);
	monthDn.setAttribute('style','padding-left:10px;padding-right:10px;');
	monthDn.setAttribute('class','btn-3 bg-primary');
...
Epoch.prototype.createFooter = function () //PRIVATE: creates the footer of the calendar - goes under the calendar cells
{
	...
	clearSelected.setAttribute('class','btn-3 bg-primary');
	clearSelected.setAttribute('style','width:40%');
